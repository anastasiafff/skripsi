...
import {
  ...
  SelectTrigger,
  SelectValue
} from "@/components/ui/select"; // Ensure this import path is correct
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Temukan produk skincare terbaik</p>
      </div>
      ...
      <div className="text-sm text-muted-foreground">Menampilkan {products.length} produk</div>

      <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {products.map((product: Product) => (
          <Card key={product.id} className="overflow-hidden pt-0 hover:shadow-lg transition-shadow">
            <div className="aspect-square bg-muted relative group">
              ...
              <Image
                src={product?.image || "/placeholder.svg"} // Fixed image path
