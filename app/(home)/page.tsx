    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 font-sans dark:bg-gradient-to-r dark:from-gray-800 dark:via-gray-900 dark:to-black">
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-center py-32 px-8 bg-white dark:bg-gray-800 rounded-3xl shadow-lg space-y-12 sm:items-start sm:text-left">
        ...
        <div className="flex flex-col items-center gap-8 text-center sm:items-start sm:text-left">
          <h1 className="text-4xl font-bold leading-tight text-gray-800 dark:text-white sm:max-w-md">To get started, edit the page.tsx file.</h1>
          <p className="text-lg leading-7 text-gray-600 dark:text-gray-300 sm:max-w-lg">
            Looking for a starting point or more instructions? Head over to{" "}
            <a href="https://vercel.com/templates?framework=next.js&utm_source=create-next-app&utm_medium=appdir-template-tw&utm_campaign=create-next-app" className="font-medium text-indigo-600 dark:text-indigo-400 hover:underline">
              Templates
            </a>{" "}
            or the{" "}
            <a href="https://nextjs.org/learn?utm_source=create-next-app&utm_medium=appdir-template-tw&utm_campaign=create-next-app" className="font-medium text-indigo-600 dark:text-indigo-400 hover:underline">
              Learning
            </a>{" "}
            center.
          </p>
