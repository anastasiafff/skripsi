...
import { IconRotateClockwise, IconSearch, IconSparkles } from "@tabler/icons-react";

import { Controller, useForm } from "react-hook-form";
import { FormValues } from "../page";

export function RecommendationForm({ onSubmit }: { onSubmit: (data: FormValues) => void }) {
  const {
    control,
    handleSubmit,
    reset,
    ...
    <div className="w-full">
      ...
      <div className="bg-slate-600 text-white py-14">
        <div className="max-w-4xl mx-auto text-center space-y-4 px-6">
          ...
          <h1 className="text-3xl font-semibold">Cari Rekomendasi Skincare</h1>
          <p className="text-sm text-white/80 max-w-xl mx-auto">Dapatkan rekomendasi produk skincare terbaik berdasarkan kategori, tipe kulit, budget, dan rating yang Anda inginkan.</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-6 -mt-10 space-y-6 mb-5">
        ...
        <Card className="bg-slate-600 text-white">
          <CardContent className="py-4 text-sm flex gap-3 items-start">
            ...
            <p>
              <span className="font-medium">Cara Menggunakan</span>
              <br />
              Pilih kategori produk, tipe kulit, tentukan budget, dan minimum rating. Sistem akan menghitung rekomendasi terbaik menggunakan metode TOPSIS.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-base">🎯 Kriteria Pencarian</CardTitle>
            <CardDescription>Tentukan kriteria produk yang Anda butuhkan</CardDescription>
          </CardHeader>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Select value={field.value} onValueChange={field.onChange}>
                      ...
                      <SelectContent>
                        <SelectItem value="0-100">RP 3.000 – 100.000</SelectItem>
                        <SelectItem value="100-200">RP 100.001 – 200.000</SelectItem>
                        <SelectItem value="200-300">RP 200.001 – 300.000</SelectItem>
                        <SelectItem value="300-400">RP 300.001 – 400.000</SelectItem>
                      </SelectContent>
                    </Select>
                  )}
                />
